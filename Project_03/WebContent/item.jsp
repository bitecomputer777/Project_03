...
<option>  4
			...
			<div class="optiontype">
				<input type="hidden" value='0' title="상품 옵션값" name="selectedRequest">
				<button class='optionbtn' type="button">
			...
			<div class="optiontyperesult" id="divorderlist">
				<ul class='itemresult'>
					<li class="typeadditem">
						<p class="prodarea">
